...
import { AddItem, FetchItemsByIdTodo, RemoveItem, SetError, UpdateFilter, UpdateFilterParameter, UpdateItem } from './item.actions';
...
export class ItemState {
  ...
  fetchItems({ getState, patchState }: StateContext<ItemStateModel>, { payload }: FetchItemsByIdTodo) {
  ...
  updateFilterParameter({ patchState }: StateContext<ItemStateModel>, { payload }: UpdateFilterParameter) {
